...
@NoArgsConstructor
@Entity
@DiscriminatorValue("COMBUSTION_FIJA")
public class CombustionFija extends Actividad {
  ...
  public CombustionFija(Combustible combustible, Double valor, Periodicidad periodicidad, LocalDate periodo,
                        FactorEmision factorEmision) {
    super(periodicidad, periodo, factorEmision, Alcance.EMISIONES_DIRECTAS, TipoActividad.COMBUSTION_FIJA);
